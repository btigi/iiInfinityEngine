...
{
    public class VvcBinaryReader : IVvcFileReader
    {
        ...
        public VvcFile Read(Stream s)
        {
            ...
            {
                var header = (VvcHeader)Common.ReadStruct(br, typeof(VvcHeader));
                ...
                vvcFile.Unused = header.Unused;
                vvcFile.Unused2 = header.Unused2;
                vvcFile.Unused3 = header.Unused3;
