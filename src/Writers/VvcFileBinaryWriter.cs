...
namespace ii.InfinityEngine.Writers
{
    public class VvcFileBinaryWriter : IVvcFileWriter
    {
        ...
        public bool Write(string filename, IEFile file, bool forceSave = false)
        {
            ...
            header.SequenceFlags = vvcFile.SequenceFlags.Looping ? Convert.ToInt16(header.SequenceFlags | Common.Bit0) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.SpecialLighting ? Convert.ToInt16(header.SequenceFlags | Common.Bit1) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.ModifyForHeight ? Convert.ToInt16(header.SequenceFlags | Common.Bit2) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.DrawAnimation ? Convert.ToInt16(header.SequenceFlags | Common.Bit3) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.CustomPalette ? Convert.ToInt16(header.SequenceFlags | Common.Bit4) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Purgeable ? Convert.ToInt16(header.SequenceFlags | Common.Bit5) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.NotCoveredByWallgroups ? Convert.ToInt16(header.SequenceFlags | Common.Bit6) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.MidLevelBrighten ? Convert.ToInt16(header.SequenceFlags | Common.Bit7) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.HighLevelBrighten ? Convert.ToInt16(header.SequenceFlags | Common.Bit8) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit9 ? Convert.ToInt16(header.SequenceFlags | Common.Bit9) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit10 ? Convert.ToInt16(header.SequenceFlags | Common.Bit10) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit11 ? Convert.ToInt16(header.SequenceFlags | Common.Bit11) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit12 ? Convert.ToInt16(header.SequenceFlags | Common.Bit12) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit13 ? Convert.ToInt16(header.SequenceFlags | Common.Bit13) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit14 ? Convert.ToInt16(header.SequenceFlags | Common.Bit14) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit15 ? Convert.ToInt16(header.SequenceFlags | Common.Bit15) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit16 ? Convert.ToInt16(header.SequenceFlags | Common.Bit16) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit17 ? Convert.ToInt16(header.SequenceFlags | Common.Bit17) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit18 ? Convert.ToInt16(header.SequenceFlags | Common.Bit18) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit19 ? Convert.ToInt16(header.SequenceFlags | Common.Bit19) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit20 ? Convert.ToInt16(header.SequenceFlags | Common.Bit20) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit21 ? Convert.ToInt16(header.SequenceFlags | Common.Bit21) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit22 ? Convert.ToInt16(header.SequenceFlags | Common.Bit22) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit23 ? Convert.ToInt16(header.SequenceFlags | Common.Bit23) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit24 ? Convert.ToInt16(header.SequenceFlags | Common.Bit24) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit25 ? Convert.ToInt16(header.SequenceFlags | Common.Bit25) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit26 ? Convert.ToInt16(header.SequenceFlags | Common.Bit26) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit27 ? Convert.ToInt16(header.SequenceFlags | Common.Bit27) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit28 ? Convert.ToInt16(header.SequenceFlags | Common.Bit28) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit29 ? Convert.ToInt16(header.SequenceFlags | Common.Bit29) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit30 ? Convert.ToInt16(header.SequenceFlags | Common.Bit30) : header.SequenceFlags;
            header.SequenceFlags = vvcFile.SequenceFlags.Bit31 ? Convert.ToInt16(header.SequenceFlags | Common.Bit31) : header.SequenceFlags;
