...
namespace ii.InfinityEngine.Readers
{
    public class ProFileBinaryReader : IProFileReader
    {
        ...
        private ProFile ParseFile(BinaryReader br)
        {
            ...
            proFile.SparkingFlags.ShowSparkle = (header.SparkingFlags & Common.Bit0) != 0;
            proFile.SparkingFlags.UseZCoordinate = (header.SparkingFlags & Common.Bit1) != 0;
            proFile.SparkingFlags.LoopFireSound = (header.SparkingFlags & Common.Bit2) != 0;
            proFile.SparkingFlags.LoopImpactSound = (header.SparkingFlags & Common.Bit3) != 0;
            proFile.SparkingFlags.DoNotAffectDirectTarget = (header.SparkingFlags & Common.Bit4) != 0;
            proFile.SparkingFlags.DrawBelowAnimateObjects = (header.SparkingFlags & Common.Bit5) != 0;
            proFile.SparkingFlags.AllowSavingGame = (header.SparkingFlags & Common.Bit6) != 0;
            proFile.SparkingFlags.LoopSpreadAnimation = (header.SparkingFlags & Common.Bit7) != 0;
            proFile.SparkingFlags.Bit8 = (header.SparkingFlags & Common.Bit8) != 0;
            proFile.SparkingFlags.Bit9 = (header.SparkingFlags & Common.Bit9) != 0;
            proFile.SparkingFlags.Bit10 = (header.SparkingFlags & Common.Bit10) != 0;
            proFile.SparkingFlags.Bit11 = (header.SparkingFlags & Common.Bit11) != 0;
            proFile.SparkingFlags.Bit12 = (header.SparkingFlags & Common.Bit12) != 0;
            proFile.SparkingFlags.Bit13 = (header.SparkingFlags & Common.Bit13) != 0;
            proFile.SparkingFlags.Bit14 = (header.SparkingFlags & Common.Bit14) != 0;
            proFile.SparkingFlags.Bit15 = (header.SparkingFlags & Common.Bit15) != 0;
            proFile.SparkingFlags.Bit16 = (header.SparkingFlags & Common.Bit16) != 0;
            proFile.SparkingFlags.Bit17 = (header.SparkingFlags & Common.Bit17) != 0;
            proFile.SparkingFlags.Bit18 = (header.SparkingFlags & Common.Bit18) != 0;
            proFile.SparkingFlags.Bit19 = (header.SparkingFlags & Common.Bit19) != 0;
            proFile.SparkingFlags.Bit20 = (header.SparkingFlags & Common.Bit20) != 0;
            proFile.SparkingFlags.Bit21 = (header.SparkingFlags & Common.Bit21) != 0;
            proFile.SparkingFlags.Bit22 = (header.SparkingFlags & Common.Bit22) != 0;
            proFile.SparkingFlags.Bit23 = (header.SparkingFlags & Common.Bit23) != 0;
            proFile.SparkingFlags.Bit24 = (header.SparkingFlags & Common.Bit24) != 0;
            proFile.SparkingFlags.Bit25 = (header.SparkingFlags & Common.Bit25) != 0;
            proFile.SparkingFlags.Bit26 = (header.SparkingFlags & Common.Bit26) != 0;
            proFile.SparkingFlags.Bit27 = (header.SparkingFlags & Common.Bit27) != 0;
            proFile.SparkingFlags.Bit28 = (header.SparkingFlags & Common.Bit28) != 0;
            proFile.SparkingFlags.Bit29 = (header.SparkingFlags & Common.Bit29) != 0;
            proFile.SparkingFlags.Bit30 = (header.SparkingFlags & Common.Bit30) != 0;
            proFile.SparkingFlags.Bit31 = (header.SparkingFlags & Common.Bit31) != 0;
            ...
            proFile.SourceAnimationBam = header.SourceAnimationBam;
            proFile.FireWav = header.FireWav;
